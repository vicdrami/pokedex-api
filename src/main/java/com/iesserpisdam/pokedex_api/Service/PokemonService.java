...
public class PokemonService {
    ...
    public PokemonResponse create(PokemonCreateRequest request) {
        ...
        pokemon.setEvolution(PokemonEvolution.UNIQUE);
    ...
    public void delete(Long id) {
        if (!repository.existsById(id)) {
            throw new RuntimeException("Ups!!Pokemon not found: " + id);
        }
    ...
    public PokemonResponse findById(Long id) {
        Pokemon pokemon = repository.findById(id).orElseThrow(() -> new NoSuchElementException("Pokemon not found: " + id));
    ...
    private PokemonResponse mapToResponse(Pokemon pokemon) {
        ...
        response.setPokedexId(pokemon.getIdPokedex());
